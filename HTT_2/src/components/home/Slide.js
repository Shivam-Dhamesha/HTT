  ...
  return (
      ...
      <div className="logo">
            ...
            <Tilt options={defaultOptions} style={{ height: 250, width: 250 }}>
              <div>
              <img className='img_slide' src="./1.webp" alt="Resource 1" />
              </div>
            </Tilt>
            </div>
            <div className="logo hidden_slide">
            <Tilt options={defaultOptions} style={{ height: 250, width: 250 }}>
              <img className='img_slide' src="./2.webp" alt="Resource 2" />
            </Tilt>
            </div>
            <div className="logo hidden_slide">
            <Tilt options={defaultOptions} style={{ height: 250, width: 250 }}>
              <img className='img_slide' src="./3.webp" alt="Resource 3" />
            </Tilt>
            </div>
            <div className="logo hidden_slide">
            <Tilt options={defaultOptions} style={{ height: 250, width: 250 }}>
              <img className='img_slide' src="./4.webp" alt="Resource 4" />
              </Tilt>
            </div>
          </div>
